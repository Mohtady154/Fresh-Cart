...
export default function Checkout() {
  ...
  let validation = Yup.object({
    details: Yup.string()
      ...
      .min(3, "Minimum letter is 3")
      .max(100, "Maximum letters is 100"),
    city: Yup.string()
      .required("City is required")
      .min(2, "Minimum letter is 2")
      .max(10, "Maximum letters is 10"),
    phone: Yup.string()
        ...
        <div className="col-md-8 mx-auto ">
          <form onSubmit={formik.handleSubmit}>
            ...
            <button
              ...
              className="col-12 btn bg-main text-white mt-1"
              style={{ width: "49%", marginLeft: "1%" }}
              onClick={() => setSelectButton("Cash")}
              type="submit"
            >
              {isLoading ? (
