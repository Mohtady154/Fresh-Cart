...
export default function ForgetPassword() {
  let { forgetPasswordApi, verifyResetCodeApi, setEmail } = useContext(
  ...
  let validationCode = Yup.object({
    resetCode: Yup.number("resetCode must be numbers").required(
        ...
        {isResetCode ? (
          <>
            <form onSubmit={formik2.handleSubmit}>
              ...
              {isLoading ? (
                <button className="btn bg-main text-white mt-1">
